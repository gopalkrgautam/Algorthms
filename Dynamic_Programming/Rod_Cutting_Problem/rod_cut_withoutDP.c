//Implementation of 'Rod-Cutting' probelm in C without Using Dynamic Programming
...
int main()
{
    int p[] = {1, 5, 8, 9, 10, 17, 17, 20, 24, 30}, n = 10;  //Here P is the Array containing price of rod-pieces of length 1 t0 10
